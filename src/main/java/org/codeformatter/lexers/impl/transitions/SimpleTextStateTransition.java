...
public class SimpleTextStateTransition extends StateTransition {

    @Override
    public ConditionalStateChange[] getConditionalStateChanges() {

        return new ConditionalStateChange[] {
                ifToken(token -> token.getLexeme().endsWith(TRIPLE_QUOTES))
                ...
                ifToken(SimpleTextStateTransition::endsWithLineTerminatingChar)
